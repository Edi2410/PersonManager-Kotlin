...
import hr.algebra.personmanager.FirstFragment
import hr.algebra.personmanager.NavigableFragment
import hr.algebra.personmanager.PERSON_ID
...
class PersonAdapter(
    ...
    = ViewHolder(itemView = LayoutInflater.from(context).inflate(R.layout.person, parent, false))
